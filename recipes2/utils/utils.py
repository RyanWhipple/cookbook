...
def send_reset_email(user):
    ...
    msg = Message(subject='Password Reset Request', sender=app.config.get('EMAIL_USER'), recipients=[user.email],body = f'''To reset your password, visit the following link:
